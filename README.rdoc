...
perhiasan batu {ruby}[http://www.ruby-lang.org/id]. Aka juga bisa diartikan singkatan dari nama 
...
khas seperti spesialnya filosofi {Ruby}[http://www.ruby-lang.org/id], yaitu 
...
request ingin kenalan (FYI {ArieKeren}[http://ariekusumaatmaja.wordpress.com/] 
suka banget punya banyak kenalan), 
request minta bikinkan library lagi (baik yang free software maupun yang berbayar 
...
AkaTime comes with ABSOLUTELY NO WARRANTY;
AkaTime is Free Software--Free as in Freedom--so you can redistribute copies
of AkaTime and modify it. See LICENSE and COPYING
